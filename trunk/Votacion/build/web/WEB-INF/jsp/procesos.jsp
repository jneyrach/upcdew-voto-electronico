...
<html>
    ...
    <body>
        ...
        <form id ="procesoForm" action="login.htm" method="post">
	...
	<ul>
		<li class="home">Votacion</li>
		<li class="menupadding"><a href="proceso.htm?accion=resultadoProceso">Resultados</a></li>
	</ul>
           </div>
            
            <div id="bodyPan">
                <h1><span>Procesos Electorales</span></h1>
