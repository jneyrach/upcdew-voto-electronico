...
public class VotoDaoImpl implements VotoDao{
    /**
     * Metodo que retorna un voto de acuerdo a los parametos de entrada
     * @parameter proceso Proceso Elctoral que se esta realizando
     * @parameter user Usuario que ha iniciado sessión en este proceso
     * @return Voto Objeto a retornar el objeto voto
    */
   ...
   /**
     * Metodo que registra el voto emitido por el usuario
     * @parameter idProceso Codigo del proceso
     * @parameter idElector Codigo del elector que esta realizando su voto
     * @parameter idCandidato Codigo del candidato elegido por el usuario
    *
    */
