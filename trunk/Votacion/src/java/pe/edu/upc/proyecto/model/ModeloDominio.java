...
public class ModeloDominio {
    ...
    public ModeloDominio() {
        ...
        proceso2.setEstadoJornada(Constantes.PROCESO_CERRADO);
        ...
        proceso2.getCandidatos().add(candidato1);
        proceso2.getCandidatos().add(candidato2);
        proceso2.getCandidatos().add(candidato3);
        proceso2.getCandidatos().add(candidato4);
        ...
        for (Persona elector : electores) {
            ...
            votoaux.setEstadoVoto(Constantes.ELECTOR_NO_VOTO);

            proceso1.getVotos().add(votoaux);
            proceso2.getVotos().add(votoaux);
        }
        /*
