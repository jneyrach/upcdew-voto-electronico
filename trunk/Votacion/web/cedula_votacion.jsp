    ...
    <body>
                        ...
                        <div id="toplinkPan">
                            <div id="toplinkfastPan">
                                ...
                                <div id="toplinksecondPan" class="tpl">
                                    <a href="#" id="${candidato.idPersona}" class="sinmarca"></a>
        ...
        <div id="bodyPan">
            <div style="height:68px">
                <p class="morenext" style="padding-top:33px"><a href="javascript: enviar()">Ok</a></p>
            </div>
        </div>

        <form name="cedulaForm" action="VotacionServlet">
